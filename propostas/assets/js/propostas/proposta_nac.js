$(document).ready(function() {
    ...
    $("#cliente").blur(function() {
        ...
        if ($(this).val() != "")
        {
            document.getElementById("frame").src = "/Clientes/propostas/index.php/clientes/clientes/find/" + $("#cliente").val();
    ...
    $("#incluir_rota").click(function() {
        ...
        $.ajax({
            ...
            url: "/Clientes/propostas/index.php/propostas/itens_propostas/incluirItemSessao/" + $("#id_tarifario").val() + "/" + $("#mercadoria").val() + "/" +
                    ...
                    $("#origem").val() + "/" + $("#embarque").val() + "/" + $("#desembarque").val() + "/" +
                    $("#destino").val() + "/" + $("#un_origem").val() + "/" + $("#un_embarque").val() + "/" +
                    $("#un_desembarque").val() + "/" + $("#un_destino").val() + "/" + values_taxas_frete + "/" +
                    labels_taxas_frete.replace("/", " ") + "/" + values_taxas_locais + "/" + labels_taxas_locais.replace("/", " ") + "/" +
                    $("#observacao_interna").val() + "/" + $("#observacao_cliente").val() + "/" + posicaoNoCombo + "/" +
                    (new Date()).getTime(),
            beforeSend: function() {
                $("#msg").html("Aguarde Processando...");
            },
