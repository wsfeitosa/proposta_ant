...
<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center" class="tabela_azul">
    <tr>
        <td>                    
            <br>				
            <?php echo form_open("index.php/propostas/propostas/alterar_proposta", Array("id" => "form_consulta", "name" => "form_consulta")); ?>
            <input type="hidden" name="sentido" id="sentido" value="<?php echo $proposta->getSentido(); ?>" />
            <input type="hidden" name="id_proposta" id="id_proposta" value="<?php echo $proposta->getId(); ?>" />
            <input type="hidden" name="tipo_proposta" value="proposta_tarifario" />
            <table cellpadding="1" cellspacing="1" width="97%" border="0" align="center" class="tabela_padrao">
                ...
                <tr>
                    <td class="texto_pb" colspan="2">							
                        <?php echo form_dropdown("clientes_selecionados[]", $conversor->converter($proposta->getClientes(), Array("value" => "id", "label" => "razao")), "", "id='clientes_selecionados' multiple='multiple' size='5'"); ?>
                        <input type="button" name="remover_cliente" id="remover_cliente" value="-" />							
                    </td>
                    <td class="texto_pb" colspan="2">							
                        <?php echo form_dropdown("contatos_cc_selecionados[]", $conversor->converter($proposta->obterEmails(), Array("value" => "email", "label" => "email")), "", "id='contatos_cc_selecionados' multiple='multiple' size='5'"); ?>	
                ...
                <tr>
                    ...
                    <td class="texto_pb">
                        <?php echo form_input(Array("name" => "peso", "id" => "peso", "size" => "5")); ?> -
                        <?php echo form_input(Array("name" => "cubagem", "id" => "cubagem", "size" => "5")); ?> -
                        <?php echo form_input(Array("name" => "volumes", "id" => "volumes", "size" => "3")); ?>
                    </td>
                    <td class="texto_pb">
                        <?php echo form_input(Array('name' => 'validade', 'id' => 'validade', 'size' => '14', 'value' => date('d-m-Y'), 'readonly' => 'readonly')); ?>
                    </td>
                </tr>
                <tr>
                    <td>Origem:</td>
                ...
                <tr>
                    ...
                    <td colspan="2">Taxas Locais:</td>
                </tr>
                <tr>
                    <td colspan="2" class="texto_pb">
                        <?php echo form_dropdown("frete_adicionais[]", Array(), "", "id='frete_adicionais' multiple='multiple' size='5'"); ?>
                    </td>
                    <td colspan="2" class="texto_pb">
                        <?php echo form_dropdown("taxas_locais[]", Array(), "", "id='taxas_locais' multiple='multiple' size='5'"); ?>
                        <input type="button" name="incluir_rota" id="incluir_rota" value="Adicionar" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="2" class="texto_pb">
                        <?php echo form_textarea(Array('name' => 'observacao_cliente', 'id' => 'observacao_cliente', 'value' => "", 'rows' => 8)); ?>
                    </td>
                </tr>	
                <tr>
                    <td colspan="4" class="titulo_tabela">
                ...
                <tr>
                    <td colspan="4" class="texto_pb">
                        <?php echo form_dropdown("rotas_adicionadas[]", $itens_serializados, "", "id='rotas_adicionadas' multiple='multiple' size='5'"); ?>
