...
class Sessao extends CI_Model {
	...
	protected $id_tarifario = "NULL", $mercadoria = "", $pp = NULL, 
	$cc = NULL, $validade = NULL, $peso = NULL, $cubagem = NULL, $volumes = NULL,
    ...
    public function inserirItemNaSessao() 
    {
        ...
        try{            
            $item_proposta = Array(
                                    ...
                                    "mercadoria" => $this->url->decodificarUrl($this->mercadoria), 
                                    "pp" => $pp,
                                    "cc" => $cc,
                                    ...
                                    "origem" => $this->url->decodificarUrl($this->origem),
                                    "embarque" => $this->url->decodificarUrl($this->embarque),
                                    "desembarque" => $this->url->decodificarUrl($this->desembarque),
                                    "destino" => $this->url->decodificarUrl($this->destino),
                                    "un_origem" => $this->un_origem,
                                    "un_embarque" => $this->un_embarque,
                                    "un_desembarque" => $this->un_desembarque,
                                    "un_destino" => $this->un_destino,
                                    "frete_adicionais" => $this->url->decodificarUrl($this->frete_adicionais),
                                    "labels_frete_adicionais" => $this->url->decodificarUrl($this->labels_fretes_adicionais),
                                    "taxas_locais" => $this->url->decodificarUrl($this->taxas_locais),
                                    "labels_taxas_locais" => $this->url->decodificarUrl($this->labels_taxas_locais),
                                    "observacao_interna" => $this->url->decodificarUrl($this->observacao_interna),
                                    "observacao_cliente" => $this->url->decodificarUrl($this->observacao_cliente)				
            );
            
        } catch (Exception $e) {
            //FIXME Quando algum campo não é informado no formulário, esta exceção está sendo arremessada
