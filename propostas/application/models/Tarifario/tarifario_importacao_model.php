...
class Tarifario_Importacao_Model extends CI_Model implements Interface_Tarifario_Model{
	...
	public $db_params = "financeiro";
	public $table = "tarifarios_pricing";
	public $primary_key = "id_tarifario_pricing";	
	public $tarifario = NULL;
	const sentido = 'IMP';
	...
	public function obterTarifarios(Rota $rota)
	{
		...
		$this->db->
			...
			where("id_via",$rota->getPortoDesembarque()->getId())->
		...
		{			
			...
			/** Preenche o porto de embarque (via) **/
			$porto_embarque = $rota->getPortoEmbarque();
