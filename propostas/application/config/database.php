...
require_once("/var/www/html/allink/config.php");

$active_group = 'financeiro';
$active_record = TRUE;

//$hostname = $arr_config_bd["servidor"];
//$username = $arr_config_bd["usuario"];
//$password = $arr_config_bd["senha"];
